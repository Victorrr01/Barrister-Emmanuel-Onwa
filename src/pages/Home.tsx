...
import { Landmark, Scale, ShieldCheck, HeartHandshake, Users, PhoneCall, CheckCircle, Calendar } from 'lucide-react';
...
export const Home: React.FC<{ onOpenBooking: () => void }> = ({ onOpenBooking }) => {
  return (
    <div className="w-full">
      {/* 1. HOME SECTION */}
      <section id="home" className="relative bg-slate-950 py-16 sm:py-12 sm:py-20 lg:py-32 overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="text-lg sm:text-2xl text-amber-400 font-medium max-w-3xl mx-auto">
      ...
      <section id="history" className="py-12 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            ...
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900">About & History</h2>
      ...
      <section id="values" className="py-12 sm:py-20 bg-slate-50 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            <ShieldCheck className="w-12 h-12 text-amber-600 mx-auto" />
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900">Firm Values</h2>
            <div className="w-24 h-1 bg-amber-500 mx-auto rounded-full"></div>
          </div>
          <div className="max-w-4xl mx-auto space-y-8">
            <p className="text-base sm:text-lg text-slate-700 text-center font-medium">
              {FIRM_VALUES_INTRO}
            </p>
      ...
      <section id="practice-areas" className="py-12 sm:py-20 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            <Scale className="w-12 h-12 text-amber-500 mx-auto" />
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold">Practice Areas</h2>
            <div className="w-24 h-1 bg-amber-500 mx-auto rounded-full"></div>
          </div>
      ...
      <section id="csr" className="py-12 sm:py-20 bg-amber-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            <HeartHandshake className="w-12 h-12 text-amber-700 mx-auto" />
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900">Corporate & Social Responsibility</h2>
      ...
      <section id="team" className="py-12 sm:py-20 bg-white border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            <Users className="w-12 h-12 text-amber-600 mx-auto" />
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900">Our Team / Lawyer Profiles</h2>
            <div className="w-24 h-1 bg-amber-500 mx-auto rounded-full"></div>
          </div>
                  ...
                  <div className="pt-4 border-t border-slate-200 space-y-2 mt-auto">
                    {member.email && (
                      <p className="text-sm text-slate-600 truncate">
                        ...
                        <a href={`mailto:${member.email}`} className="text-amber-700 hover:underline break-all">{member.email}</a>
                      </p>
                    )}
                    {member.telephone && (
      ...
      <section id="contact" className="py-12 sm:py-20 bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl text-slate-300 font-medium tracking-wide">{CONTACT_INFO.firmName}</h3>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 md:p-12 space-y-8 mt-8 shadow-xl">
            <div>
              ...
              <p className="text-lg sm:text-xl md:text-2xl font-serif">{CONTACT_INFO.address}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-slate-800">
              <div>
                ...
                <div className="space-y-2">
                  <a href={`mailto:${CONTACT_INFO.email1}`} className="block text-base sm:text-lg text-amber-400 hover:text-amber-300 transition-colors break-all">
                    {CONTACT_INFO.email1}
                  </a>
                  <a href={`mailto:${CONTACT_INFO.email2}`} className="block text-base sm:text-lg text-amber-400 hover:text-amber-300 transition-colors break-all">
                    {CONTACT_INFO.email2}
                  </a>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <a href={`tel:${CONTACT_INFO.phone1}`} className="block text-base sm:text-lg text-amber-400 hover:text-amber-300 transition-colors break-all">
                    {CONTACT_INFO.phone1}
                  </a>
                  <a href={`tel:${CONTACT_INFO.phone2}`} className="block text-base sm:text-lg text-amber-400 hover:text-amber-300 transition-colors break-all">
                    {CONTACT_INFO.phone2}
                  </a>
                </div>
              </div>
