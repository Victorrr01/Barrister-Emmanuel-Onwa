export const FIRM_NAME = "I.E. ONWA & CO. (REDEMPTION CHAMBERS)";

export const CONTACT_INFO = {
  name: "I.E. ONWA & CO",
  firmName: "REDEMPTION CHAMBERS",
  address: "43, Dele Abubakar Street (Stadium Road), Ilorin, Kwara State",
  email1: "Iawyeronwajr@gmail.com",
  email2: "lawyeronwajr@gmail.com",
  phone1: "+2348064710262",
  phone2: "08064710262"
};
...
export const FIRM_VALUES = [
  "Sectorial knowledge — an intimate knowledge of the sectors in which the firm operates, enabling informed advice on strategy, individual deals, and disputes.",
  "An approach to litigation and corporate practice underpinned by many years of involvement in litigation and arbitration cases.",
  "Knowledge and accessibility — clients can contact associates or partners directly on any project, case, or work, fostering cooperation and harmony between the firm and its clients.",
  "Being a fully integrated commercial law firm representing clients from a range of industries and sectors, public and private, worldwide, drawing on an extensive referral network to help clients meet their commercial objectives efficiently.",
  "International and regional ability to acquire property for clients anywhere in the world, with experienced, professional negotiation to secure the right property at an attractive price."
];
...
export const PRACTICE_AREAS = [
  ...
  "Corporate Practice",
  "Property Consultants/Infrastructure",
  "Telecommunication",
